...
Preview (read-only): .venv/bin/python src/thread_archive/scripts/repair_grok_tool_names.py
Apply:               .venv/bin/python src/thread_archive/scripts/repair_grok_tool_names.py --apply
"""
...
from thread_archive.store import use_session
from thread_archive.store.models import Event, EventFts
from thread_archive.truth.jsonl_log import append_event_row
