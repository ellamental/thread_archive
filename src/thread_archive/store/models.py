...
# tables (see :mod:`thread_archive.knowledge.materialize`). A legacy snapshot of the
...
class KgEvent(Base):
    ...
    projections by :mod:`thread_archive.knowledge.materialize`. The log is the source
