...
``kind`` tells archive how ``thread-archive source import --provider <name>`` reaches the
...
class Provider:
    ...
    key for config opt-out, ``thread-archive source import --provider``, and search filters. It
