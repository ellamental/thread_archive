...
for the reverse — the ``uninstall`` verb's removal flow and leftovers report.
The ``setup`` verb of :mod:`..cli` drives :func:`.wizard.run_setup`, and the
``status`` view is :func:`.wizard.print_status`.
