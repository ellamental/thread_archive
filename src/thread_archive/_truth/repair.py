...
The sanctioned path from a red ``thread-archive index verify`` back to green. An unparseable
...
After a repair that excised fragments, the next ``thread-archive backup run`` may need
