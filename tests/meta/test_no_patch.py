...
BASELINE: dict[str, int] = {
    "conftest.py": 2,
    "test_backfill_codex_model.py": 3,
    "test_backfill_dropped_fields.py": 5,
    "test_backfill_export_annotations.py": 5,
    "test_backfill_subagent_type.py": 1,
    "test_backup_mirror.py": 4,
    "test_cli_smoke.py": 3,
    "test_cov_api.py": 5,
    "test_cov_cli.py": 23,
    "test_cov_importers_a.py": 3,
    "test_cov_importers_b.py": 6,
    "test_cov_ops_truth.py": 7,
    "test_cov_scripts.py": 14,
    "test_cov_setup.py": 3,
    "test_cov_watcher.py": 15,
    "test_dedup_collapse_and_deep_verify.py": 2,
    "test_drift_snapshot.py": 2,
    "test_durability_and_homes.py": 1,
    "test_export_drop.py": 3,
    "test_exthost.py": 1,
    "test_integrity_hardening.py": 3,
    "test_knowledge_facade.py": 2,
    "test_lazy_ingest.py": 2,
    "test_mcp.py": 12,
    "test_nightly.py": 7,
    "test_parse_validation.py": 1,
    "test_preserve_cursor_import.py": 1,
    "test_preserve_exports.py": 2,
    "test_repair.py": 4,
    "test_search.py": 2,
    "test_self_update.py": 6,
    "test_source_mirror.py": 1,
    "test_store.py": 5,
    "test_truth.py": 3,
    "test_truth_manifest.py": 1,
    "test_truth_repair.py": 1,
    "test_usage_ledger.py": 2,
    "test_watch.py": 5,
    "test_web.py": 5,
}
